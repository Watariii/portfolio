    ...
    >
      <div className="container max-w-4xl mx-auto text-center z-10">
        <div className="space-y-6">
          <h1 className="flex  items-center justify-center gap-2 text-4xl md:text-6xl font-bold tracking-tight">
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 flex flex-col items-center opacity-0 animate-fade-in-delay-4">
        <a href="#about" className="flex flex-col items-center ">
          ...
          <ArrowDown className="h-5 w-5 text-primary animate-bounce cursor-pointer" />
        </a>
      </div>
    </section>
  );
